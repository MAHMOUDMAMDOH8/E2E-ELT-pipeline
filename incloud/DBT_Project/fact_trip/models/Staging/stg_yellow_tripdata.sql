...
(
  ...
  from {{ source('staging','yellow_trip') }}  -- Updated to match the source name
  where vendorid is not null and passenger_count > 0
)
...
select
    ...
    1 as trip_type,
    {{ map_trip_type('1') }} as trip_type_description, 
